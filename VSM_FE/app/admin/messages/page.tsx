...
const mockConversations = {
  user1: [
    ...
    },
    {
      ...
      sender: "admin",
      content:
        "Xin chào! Sự kiện Marathon Hà Nội 2024 sẽ diễn ra vào ngày 15/3/2024. Bạn có thể tham khảo thông tin chi tiết tại trang sự kiện của chúng tôi.",
    ...
    },
    {
      ...
      sender: "admin",
      content:
        "Lệ phí là 800k bao gồm áo, số báo và medal. Bạn cần có giấy chứng nhận sức khỏe và kinh nghiệm chạy Half Marathon trước đó.",
  ...
  user2: [
    {
      ...
      sender: "user",
      content:
        "Admin ơi, tôi đã đăng ký sự kiện 5K Fun Run từ tuần trước nhưng chưa nhận được email xác nhận",
    ...
    },
    {
      ...
      sender: "admin",
      content:
        "Chào bạn! Tôi sẽ kiểm tra hệ thống ngay. Bạn có thể cung cấp email đăng ký không?",
...
export default function AdminMessagePage() {
  ...
  useEffect(() => {
    ...
    if (userId && userId !== "new") {
      ...
      setMessages(
        mockConversations[userId as keyof typeof mockConversations] || []
      );
    }
  }, [params.userId]);

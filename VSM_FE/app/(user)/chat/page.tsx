...
const mockMessages = [
  ...
  },
  {
    ...
    sender: "user",
    content:
      "Chào admin! Tôi muốn hỏi về việc đăng ký sự kiện Marathon Hà Nội 2024",
  ...
  },
  {
    ...
    sender: "admin",
    content:
      "Sự kiện Marathon Hà Nội 2024 sẽ diễn ra vào ngày 15/3/2024. Hiện tại chúng tôi vẫn đang mở đăng ký với giá 800k/người. Bạn có muốn tôi hướng dẫn cách đăng ký không?",
  ...
  },
  {
    ...
    sender: "user",
    content:
      "Vâng, xin admin hướng dẫn ạ. Tôi cần chuẩn bị gì trước khi đăng ký?",
  ...
  const handleSendMessage = () => {
    ...
    setTimeout(() => {
      ...
      const adminResponse = {
        ...
        sender: "admin",
        content:
          "Cảm ơn bạn đã liên hệ! Tôi sẽ xem xét và phản hồi sớm nhất có thể.",
        timestamp: new Date().toISOString(),
        status: "read",
        type: "text",
      };
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="font-medium text-sm">
                    Chào mừng đến với hỗ trợ VSM!
                  </p>
                  <p className="text-xs text-muted-foreground">
                    Chúng tôi sẽ phản hồi trong vòng 15 phút trong giờ hành
                    chính
                  </p>
                </div>
              </div>
                  ...
                  return (
                    ...
                    >
                      ...
                      >
                        ...
                        <div
                          className={`${
                            !isConsecutive ? "" : isUser ? "mr-10" : "ml-10"
                          }`}
                        >
                          <div
            ...
            <div className="px-4 py-2 border-t bg-gray-50/50">
              <div className="flex gap-2 flex-wrap">
                <Button
                  ...
                  className="text-xs"
                  onClick={() =>
                    setNewMessage("Tôi muốn hỏi về sự kiện sắp tới")
                  }
                >

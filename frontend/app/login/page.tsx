                ...
                <div className="space-y-2">
                  ...
                  <div className="space-y-1 text-sm text-blue-700 dark:text-blue-300">
                    <div className="flex justify-between items-center">
                      <span>👤 User 1: user1@vsm.org.vn</span>
                      <Button
                        size="sm"
                        variant="outline"
                    ...
                    <div className="flex justify-between items-center">
                      <span>👤 User 2: user2@vsm.org.vn</span>
                      <Button
                        size="sm"
                        variant="outline"
                        onClick={() => handleDemoLogin("user2@vsm.org.vn")}
                        className="h-6 px-2 text-xs"
                        type="button"
                      >
                        Dùng
                    ...
                    <div className="flex justify-between items-center">
                      <span>👤 Test User: testuser@vsm.org.vn</span>
                      <Button
                        size="sm"
                        variant="outline"
                        onClick={() => handleDemoLogin("testuser@vsm.org.vn")}
                        className="h-6 px-2 text-xs"
                        type="button"
                      >
                        Dùng

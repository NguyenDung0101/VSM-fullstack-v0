...
import { Calendar, MapPin, Clock, ArrowLeft, Share2, Heart, UserPlus, CheckCircle, Info } from "lucide-react"
  ...
  const onSubmit = async (data: RegistrationForm) => {
    try {
      ...
      toast({
        ...
        description: "Bạn đã đăng ký tham gia sự kiện thành công. Chúng tôi sẽ liên hệ với bạn sớm.",
      })
    } catch (error) {
      toast({
                    ...
                    {isEventPast && (
                      <div className="bg-muted p-4 rounded-lg mb-6">
                        <div className="flex items-center">
                          ...
                          <span className="text-muted-foreground">Sự kiện này đã kết thúc</span>
                        </div>
                      </div>
                    )}
                    ...
                    {isRegistered && (
                      <div className="bg-green-50 border border-green-200 p-4 rounded-lg mb-6">
                        <div className="flex items-center">
                          ...
                          <span className="text-green-800 font-medium">Bạn đã đăng ký tham gia sự kiện này</span>
                        </div>
                      </div>
                    )}
                  </div>
                    ...
                    <CardContent>
                      <div className="prose max-w-none">
                        ...
                        <ul>
                          ...
                          <li>Số lượng tham gia tối đa: {event.maxParticipants} người</li>
                        ...
                        <ul>
                          <li>Người tham gia phải có trách nhiệm với sức khỏe của bản thân</li>
                          <li>Ban tổ chức sẽ cung cấp nước uống và y tế cơ bản</li>
                          <li>Sự kiện có thể bị hoãn hoặc hủy do thời tiết xấu</li>
                        </ul>
                      </div>
                    </CardContent>
                  </Card>
                ...
                <div className="space-y-6">
                            ...
                            <Form {...form}>
                              <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
                                ...
                                <FormField
                                  ...
                                  render={({ field }) => (
                                    <FormItem>
                                      <FormLabel>Kinh nghiệm chạy bộ</FormLabel>
                                      <FormControl>
                                        <select
                                          {...field}
                                ...
                                <FormField
                                  ...
                                  render={({ field }) => (
                                    <FormItem>
                                      <FormLabel>Tình trạng sức khỏe (nếu có)</FormLabel>
                                      <FormControl>
                                        <Textarea
                  ...
                  <Card>
                    ...
                    <CardContent className="space-y-3">
                      <div className="flex items-center justify-between">
                        <span className="text-sm text-muted-foreground">Ngày tổ chức:</span>
                        <span className="text-sm font-medium">{eventDate.toLocaleDateString("vi-VN")}</span>
                      </div>
                      <div className="flex items-center justify-between">
                  ...
                  <Card>
                    ...
                    <CardContent className="space-y-3">
                      ...
                      <div>
                        <p className="text-sm text-muted-foreground">Fanpage:</p>
                        <p className="text-sm font-medium">facebook.com/VSMVietnam</p>
                      </div>
                    </CardContent>
                  </Card>
                </div>

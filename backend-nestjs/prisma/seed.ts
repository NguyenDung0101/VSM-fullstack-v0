...
Cuối cùng, hãy nhớ rằng hoàn thành marathon đầu tiên là một thành tựu đáng tự hào. Tận hưởng từng khoảnh khắc!`,
  ...
  const post2 = await prisma.post.create({
    data: {
      ...
      excerpt:
        "Hướng dẫn chi tiết về chế độ dinh dưỡng phù hợp cho người chạy bộ, giúp tăng hiệu suất và hồi phục nhanh chóng.",
...
Vietnam Student Marathon 2024 đang đến gần! Đây là sự kiện chạy bộ lớn nhất dành cho sinh viên Việt Nam.`,
  ...
  const event1 = await prisma.event.create({
    data: {
      ...
      content:
        "Sự kiện chạy bộ thường niên lớn nhất dành cho cộng đồng sinh viên với cự ly marathon đầy thử thách 42.195km.",
      ...
      requirements:
        "Sinh viên đang học tại Việt Nam, Giấy khám sức khỏe, Bảo hiểm y tế",
      published: true,
      featured: true,
  ...
  const event2 = await prisma.event.create({
    data: {
      ...
      content:
        "Chạy qua những con đường đẹp nhất của Sài Gòn với cự ly half marathon 21.1km.",

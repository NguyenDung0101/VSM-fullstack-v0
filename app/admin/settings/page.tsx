            ...
            <div>
              <div>
                ...
                <p className="text-muted-foreground">
                  Quản lý cài đặt và cấu hình hệ thống VSM
                </p>
              </div>
                            ...
                            <FormField
                              ...
                              render={({ field }) => (
                                <FormItem>
                                  ...
                                  <FormControl>
                                    <Input
                                      placeholder="Vietnam Student Marathon"
                                      {...field}
                                    />
                                  </FormControl>
                                  <FormMessage />
                              ...
                              render={({ field }) => (
                                <FormItem className="flex flex-row items-center justify-between rounded-lg border p-4">
                                  <div className="space-y-0.5">
                                    ...
                                    <FormDescription>
                                      Thông báo khi có bài viết mới được đăng
                                    </FormDescription>
                                  </div>
                                  <FormControl>
                                    <Switch
                            ...
                            render={({ field }) => (
                              <FormItem className="flex flex-row items-center justify-between rounded-lg border p-4">
                                <div className="space-y-0.5">
                                  ...
                                  <FormDescription>
                                    Bật xác thực 2 bước cho tài khoản admin
                                  </FormDescription>
                                </div>
                                <FormControl>
                                  <Switch
                            ...
                            <FormField
                              ...
                              render={({ field }) => (
                                <FormItem>
                                  ...
                                  <FormDescription>
                                    Từ 15 phút đến 24 giờ (1440 phút)
                                  </FormDescription>
                                  <FormMessage />
                                </FormItem>
                              )}
                        ...
                        <Card>
                          ...
                          <CardContent className="space-y-4">
                            <p className="text-sm text-muted-foreground">
                              Tạo bản sao lưu ngay lập tức cho toàn bộ dữ liệu
                              hệ thống.
                            </p>

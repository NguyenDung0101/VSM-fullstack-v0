      ...
      >
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-muted-foreground">Quản lý các sản phẩm VSM</p>
          </div>
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Textarea placeholder="Nhập mô tả sản phẩm" rows={3} {...field} />
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                    )}
          ...
          <CardContent>
                    ...
                    <TableCell>
                      <div className="flex items-center space-x-3">
                        ...
                        <div>
                          ...
                          {product.featured && <Badge className="mt-1 bg-yellow-500 text-white">Nổi bật</Badge>}
                        </div>
                      </div>
                    </TableCell>
                    <TableCell>
            ...
            {filteredProducts.length === 0 && (
              <div className="text-center py-8">
                ...
                <p className="mt-2 text-muted-foreground">Không có sản phẩm nào</p>
              </div>
            )}
          </CardContent>
        </Card>
